...
public partial class V1beta1BackendServiceSignedURLKeyList : IKubernetesObject<V1ListMeta>, IItems<V1beta1BackendServiceSignedURLKey>
{
    ...
    public const string KubeKind = "BackendServiceSignedURLKeyList";
    public const string KubeGroup = "compute.gcp.upbound.io";
    public const string KubePluralName = "backendservicesignedurlkeys";
    ...
    public string Kind { get; set; } = "BackendServiceSignedURLKeyList";
...
public partial class V1beta1BackendServiceSignedURLKeySpecForProviderBackendServiceRefPolicy
{
    ...
    public V1beta1BackendServiceSignedURLKeySpecForProviderBackendServiceRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1BackendServiceSignedURLKeySpecForProviderBackendServiceRef
{
    ...
    public V1beta1BackendServiceSignedURLKeySpecForProviderBackendServiceRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1BackendServiceSignedURLKeySpecForProviderBackendServiceSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1BackendServiceSignedURLKeySpecForProviderBackendServiceSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1BackendServiceSignedURLKeySpecForProvider
{
    ...
    public V1beta1BackendServiceSignedURLKeySpecForProviderBackendServiceRef? BackendServiceRef { get; set; }

    /// <summary>Selector for a BackendService in compute to populate backendService.</summary>
    [JsonPropertyName("backendServiceSelector")]
    public V1beta1BackendServiceSignedURLKeySpecForProviderBackendServiceSelector? BackendServiceSelector { get; set; }
    ...
    public V1beta1BackendServiceSignedURLKeySpecForProviderKeyValueSecretRef? KeyValueSecretRef { get; set; }
...
public partial class V1beta1BackendServiceSignedURLKeySpecInitProviderBackendServiceRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1BackendServiceSignedURLKeySpecInitProviderBackendServiceRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1BackendServiceSignedURLKeySpecInitProviderBackendServiceRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1BackendServiceSignedURLKeySpecInitProviderBackendServiceRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1BackendServiceSignedURLKeySpecInitProviderBackendServiceSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1BackendServiceSignedURLKeySpecInitProviderBackendServiceSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1BackendServiceSignedURLKeySpecInitProvider
{
    ...
    /// <summary>Reference to a BackendService in compute to populate backendService.</summary>
    [JsonPropertyName("backendServiceRef")]
    public V1beta1BackendServiceSignedURLKeySpecInitProviderBackendServiceRef? BackendServiceRef { get; set; }

    /// <summary>Selector for a BackendService in compute to populate backendService.</summary>
    [JsonPropertyName("backendServiceSelector")]
    public V1beta1BackendServiceSignedURLKeySpecInitProviderBackendServiceSelector? BackendServiceSelector { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("keyValueSecretRef")]
    public required V1beta1BackendServiceSignedURLKeySpecInitProviderKeyValueSecretRef KeyValueSecretRef { get; set; }
...
public partial class V1beta1BackendServiceSignedURLKeySpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1BackendServiceSignedURLKeySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1BackendServiceSignedURLKeySpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1BackendServiceSignedURLKeySpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1BackendServiceSignedURLKeySpec
{
    ...
    public V1beta1BackendServiceSignedURLKeySpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1BackendServiceSignedURLKeySpecForProvider ForProvider { get; set; }
    ...
    public V1beta1BackendServiceSignedURLKeySpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1BackendServiceSignedURLKeySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1BackendServiceSignedURLKeySpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1BackendServiceSignedURLKeyStatusAtProvider
{
    ...
    /// <summary>an identifier for the resource with format projects/{{project}}/global/backendServices/{{backend_service}}</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1BackendServiceSignedURLKeyStatus
{
    ...
    public V1beta1BackendServiceSignedURLKeyStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1BackendServiceSignedURLKeyStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "BackendServiceSignedURLKey";
    public const string KubeGroup = "compute.gcp.upbound.io";
    public const string KubePluralName = "backendservicesignedurlkeys";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "BackendServiceSignedURLKey";
    ...
    public required V1beta1BackendServiceSignedURLKeySpec Spec { get; set; }

    /// <summary>BackendServiceSignedURLKeyStatus defines the observed state of BackendServiceSignedURLKey.</summary>
    [JsonPropertyName("status")]
    public V1beta1BackendServiceSignedURLKeyStatus? Status { get; set; }
}