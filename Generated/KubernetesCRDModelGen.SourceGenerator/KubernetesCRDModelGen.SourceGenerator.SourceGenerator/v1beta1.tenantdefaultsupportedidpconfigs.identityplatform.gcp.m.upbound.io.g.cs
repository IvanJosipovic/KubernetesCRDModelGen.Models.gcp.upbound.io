...
public partial class V1beta1TenantDefaultSupportedIdPConfigList : IKubernetesObject<V1ListMeta>, IItems<V1beta1TenantDefaultSupportedIdPConfig>
{
    ...
    public string Kind { get; set; } = "TenantDefaultSupportedIdPConfigList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1TenantDefaultSupportedIdPConfig objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1TenantDefaultSupportedIdPConfig> Items { get; set; }
}
...
public partial class V1beta1TenantDefaultSupportedIdPConfigSpecInitProvider
{
    /// <summary>OAuth client ID</summary>
    [JsonPropertyName("clientIdSecretRef")]
    public required V1beta1TenantDefaultSupportedIdPConfigSpecInitProviderClientIdSecretRef ClientIdSecretRef { get; set; }

    /// <summary>OAuth client secret</summary>
    [JsonPropertyName("clientSecretSecretRef")]
    public required V1beta1TenantDefaultSupportedIdPConfigSpecInitProviderClientSecretSecretRef ClientSecretSecretRef { get; set; }
...
public partial class V1beta1TenantDefaultSupportedIdPConfigSpec
{
    ...
    public required V1beta1TenantDefaultSupportedIdPConfigSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1TenantDefaultSupportedIdPConfig : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1TenantDefaultSupportedIdPConfigSpec>, IStatus<V1beta1TenantDefaultSupportedIdPConfigStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TenantDefaultSupportedIdPConfig";
    ...
    public required V1beta1TenantDefaultSupportedIdPConfigSpec Spec { get; set; }
