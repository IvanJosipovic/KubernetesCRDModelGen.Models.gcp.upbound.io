...
/// <summary>Channel is the Schema for the Channels API. The Eventarc Channel resource</summary>
...
public partial class V1beta1ChannelList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Channel>
{
    ...
    /// <summary>List of V1beta1Channel objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1Channel> Items { get; set; }
}
...
public partial class V1beta1ChannelSpecProviderConfigRefPolicy
{
    ...
    public V1beta1ChannelSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ChannelSpec
{
    ...
    public V1beta1ChannelSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1ChannelSpecForProvider ForProvider { get; set; }
    ...
    public IList<V1beta1ChannelSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
...
public partial class V1beta1Channel : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ChannelSpec>, IStatus<V1beta1ChannelStatus?>
{
    ...
    public required V1beta1ChannelSpec Spec { get; set; }
