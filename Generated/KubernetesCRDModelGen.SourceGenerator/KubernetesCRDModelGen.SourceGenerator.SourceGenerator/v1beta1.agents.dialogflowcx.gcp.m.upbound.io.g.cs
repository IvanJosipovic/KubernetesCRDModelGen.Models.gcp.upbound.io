...
public partial class V1beta1AgentList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Agent>
{
    ...
    /// <summary>List of V1beta1Agent objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1Agent> Items { get; set; }
}
...
public partial class V1beta1AgentSpecForProviderAdvancedSettings
{
    ...
    public V1beta1AgentSpecForProviderAdvancedSettingsAudioExportGcsDestination? AudioExportGcsDestination { get; set; }

    /// <summary>Define behaviors for DTMF (dual tone multi frequency). DTMF settings does not override each other. DTMF settings set at different levels define DTMF detections running in parallel. Exposed at the following levels:</summary>
    [JsonPropertyName("dtmfSettings")]
    public V1beta1AgentSpecForProviderAdvancedSettingsDtmfSettings? DtmfSettings { get; set; }

    /// <summary>Settings for logging. Settings for Dialogflow History, Contact Center messages, StackDriver logs, and speech logging. Exposed at the following levels:</summary>
    [JsonPropertyName("loggingSettings")]
    public V1beta1AgentSpecForProviderAdvancedSettingsLoggingSettings? LoggingSettings { get; set; }
...
public partial class V1beta1AgentSpecForProvider
{
    ...
    public V1beta1AgentSpecForProviderGenAppBuilderSettings? GenAppBuilderSettings { get; set; }
    ...
    public V1beta1AgentSpecForProviderGitIntegrationSettings? GitIntegrationSettings { get; set; }
    ...
    public V1beta1AgentSpecForProviderTextToSpeechSettings? TextToSpeechSettings { get; set; }
...
public partial class V1beta1AgentSpecInitProviderAdvancedSettings
{
    /// <summary>If present, incoming audio is exported by Dialogflow to the configured Google Cloud Storage destination. Exposed at the following levels:</summary>
    [JsonPropertyName("audioExportGcsDestination")]
    public V1beta1AgentSpecInitProviderAdvancedSettingsAudioExportGcsDestination? AudioExportGcsDestination { get; set; }

    /// <summary>Define behaviors for DTMF (dual tone multi frequency). DTMF settings does not override each other. DTMF settings set at different levels define DTMF detections running in parallel. Exposed at the following levels:</summary>
    [JsonPropertyName("dtmfSettings")]
    public V1beta1AgentSpecInitProviderAdvancedSettingsDtmfSettings? DtmfSettings { get; set; }

    /// <summary>Settings for logging. Settings for Dialogflow History, Contact Center messages, StackDriver logs, and speech logging. Exposed at the following levels:</summary>
    [JsonPropertyName("loggingSettings")]
    public V1beta1AgentSpecInitProviderAdvancedSettingsLoggingSettings? LoggingSettings { get; set; }
...
public partial class V1beta1AgentSpecInitProvider
{
    ...
    /// </summary>
    [JsonPropertyName("genAppBuilderSettings")]
    public V1beta1AgentSpecInitProviderGenAppBuilderSettings? GenAppBuilderSettings { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("gitIntegrationSettings")]
    public V1beta1AgentSpecInitProviderGitIntegrationSettings? GitIntegrationSettings { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("textToSpeechSettings")]
    public V1beta1AgentSpecInitProviderTextToSpeechSettings? TextToSpeechSettings { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1AgentSpecManagementPoliciesEnum>))]
...
public partial class V1beta1AgentSpec
{
    ...
    public required V1beta1AgentSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1AgentStatusAtProviderAdvancedSettings
{
    /// <summary>If present, incoming audio is exported by Dialogflow to the configured Google Cloud Storage destination. Exposed at the following levels:</summary>
    [JsonPropertyName("audioExportGcsDestination")]
    public V1beta1AgentStatusAtProviderAdvancedSettingsAudioExportGcsDestination? AudioExportGcsDestination { get; set; }

    /// <summary>Define behaviors for DTMF (dual tone multi frequency). DTMF settings does not override each other. DTMF settings set at different levels define DTMF detections running in parallel. Exposed at the following levels:</summary>
    [JsonPropertyName("dtmfSettings")]
    public V1beta1AgentStatusAtProviderAdvancedSettingsDtmfSettings? DtmfSettings { get; set; }

    /// <summary>Settings for logging. Settings for Dialogflow History, Contact Center messages, StackDriver logs, and speech logging. Exposed at the following levels:</summary>
    [JsonPropertyName("loggingSettings")]
    public V1beta1AgentStatusAtProviderAdvancedSettingsLoggingSettings? LoggingSettings { get; set; }
...
public partial class V1beta1AgentStatusAtProvider
{
    ...
    /// </summary>
    [JsonPropertyName("genAppBuilderSettings")]
    public V1beta1AgentStatusAtProviderGenAppBuilderSettings? GenAppBuilderSettings { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("gitIntegrationSettings")]
    public V1beta1AgentStatusAtProviderGitIntegrationSettings? GitIntegrationSettings { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("speechToTextSettings")]
    public V1beta1AgentStatusAtProviderSpeechToTextSettings? SpeechToTextSettings { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("textToSpeechSettings")]
    public V1beta1AgentStatusAtProviderTextToSpeechSettings? TextToSpeechSettings { get; set; }
...
public partial class V1beta1Agent : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1AgentSpec>, IStatus<V1beta1AgentStatus?>
{
    ...
    public required V1beta1AgentSpec Spec { get; set; }
