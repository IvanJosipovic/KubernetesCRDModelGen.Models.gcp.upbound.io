...
namespace KubernetesCRDModelGen.Models.cloud.gcp.m.upbound.io;
...
public partial class V1beta1IdsEndpointList : IKubernetesObject<V1ListMeta>, IItems<V1beta1IdsEndpoint>
{
    ...
    public const string KubeGroup = "cloud.gcp.m.upbound.io";
    public const string KubePluralName = "idsendpoints";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    public string ApiVersion { get; set; } = "cloud.gcp.m.upbound.io/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "IdsEndpointList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1IdsEndpoint objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1IdsEndpoint> Items { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1IdsEndpointSpecManagementPoliciesEnum>))]
...
public partial class V1beta1IdsEndpointSpec
{
    ...
    public required V1beta1IdsEndpointSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1IdsEndpoint : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1IdsEndpointSpec>, IStatus<V1beta1IdsEndpointStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "IdsEndpoint";
    ...
    public required V1beta1IdsEndpointSpec Spec { get; set; }
