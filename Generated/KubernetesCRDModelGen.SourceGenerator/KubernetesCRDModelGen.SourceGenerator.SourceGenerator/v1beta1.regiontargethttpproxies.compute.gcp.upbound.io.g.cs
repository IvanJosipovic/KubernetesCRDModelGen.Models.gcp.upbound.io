...
public partial class V1beta1RegionTargetHTTPProxyList : IKubernetesObject<V1ListMeta>, IItems<V1beta1RegionTargetHTTPProxy>
{
    ...
    public string Kind { get; set; } = "RegionTargetHTTPProxyList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1RegionTargetHTTPProxy objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1RegionTargetHTTPProxy> Items { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpecForProviderUrlMapRefPolicy
{
    ...
    public V1beta1RegionTargetHTTPProxySpecForProviderUrlMapRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1RegionTargetHTTPProxySpecForProviderUrlMapRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpecForProviderUrlMapRef
{
    ...
    public V1beta1RegionTargetHTTPProxySpecForProviderUrlMapRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpecForProviderUrlMapSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1RegionTargetHTTPProxySpecForProviderUrlMapSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1RegionTargetHTTPProxySpecForProviderUrlMapSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpecForProvider
{
    ...
    public V1beta1RegionTargetHTTPProxySpecForProviderUrlMapRef? UrlMapRef { get; set; }

    /// <summary>Selector for a RegionURLMap in compute to populate urlMap.</summary>
    [JsonPropertyName("urlMapSelector")]
    public V1beta1RegionTargetHTTPProxySpecForProviderUrlMapSelector? UrlMapSelector { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapSelector
{
    ...
    /// <summary>Policies for selection.</summary>
    [JsonPropertyName("policy")]
    public V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapSelectorPolicy? Policy { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpecInitProvider
{
    ...
    /// <summary>Reference to a RegionURLMap in compute to populate urlMap.</summary>
    [JsonPropertyName("urlMapRef")]
    public V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapRef? UrlMapRef { get; set; }

    /// <summary>Selector for a RegionURLMap in compute to populate urlMap.</summary>
    [JsonPropertyName("urlMapSelector")]
    public V1beta1RegionTargetHTTPProxySpecInitProviderUrlMapSelector? UrlMapSelector { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1RegionTargetHTTPProxySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1RegionTargetHTTPProxySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1RegionTargetHTTPProxySpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1RegionTargetHTTPProxySpec
{
    ...
    public V1beta1RegionTargetHTTPProxySpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1RegionTargetHTTPProxySpecForProvider ForProvider { get; set; }
    ...
    public V1beta1RegionTargetHTTPProxySpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1RegionTargetHTTPProxySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1RegionTargetHTTPProxySpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1RegionTargetHTTPProxyStatusAtProvider
{
    ...
    /// <summary>an identifier for the resource with format projects/{{project}}/regions/{{region}}/targetHttpProxies/{{name}}</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1RegionTargetHTTPProxyStatus
{
    ...
    public V1beta1RegionTargetHTTPProxyStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1RegionTargetHTTPProxyStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "RegionTargetHTTPProxy";
    public const string KubeGroup = "compute.gcp.upbound.io";
    public const string KubePluralName = "regiontargethttpproxies";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "RegionTargetHTTPProxy";
    ...
    public required V1beta1RegionTargetHTTPProxySpec Spec { get; set; }
