...
public partial class V1beta1ClusterList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Cluster>
{
    ...
    public string ApiVersion { get; set; } = "containerazure.gcp.m.upbound.io/v1beta1";
...
public partial class V1beta1ClusterSpecForProvider
{
    ...
    public V1beta1ClusterSpecForProviderAzureServicesAuthentication? AzureServicesAuthentication { get; set; }
...
public partial class V1beta1ClusterSpecInitProvider
{
    ...
    /// <summary>Azure authentication configuration for management of Azure resources</summary>
    [JsonPropertyName("azureServicesAuthentication")]
    public V1beta1ClusterSpecInitProviderAzureServicesAuthentication? AzureServicesAuthentication { get; set; }
...
public partial class V1beta1ClusterStatusAtProvider
{
    ...
    /// <summary>Azure authentication configuration for management of Azure resources</summary>
    [JsonPropertyName("azureServicesAuthentication")]
    public V1beta1ClusterStatusAtProviderAzureServicesAuthentication? AzureServicesAuthentication { get; set; }
