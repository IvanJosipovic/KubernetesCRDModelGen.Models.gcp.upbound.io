...
public partial class V1beta1FunctionSpecForProvider
{
    ...
    public V1beta1FunctionSpecForProviderAutomaticUpdatePolicy? AutomaticUpdatePolicy { get; set; }
    ...
    public V1beta1FunctionSpecForProviderOnDeployUpdatePolicy? OnDeployUpdatePolicy { get; set; }
...
public partial class V1beta1FunctionSpecInitProvider
{
    /// <summary>Security patches are applied automatically to the runtime without requiring the function to be redeployed. This should be specified as an empty block and cannot be set alongside on_deploy_update_policy.</summary>
    [JsonPropertyName("automaticUpdatePolicy")]
    public V1beta1FunctionSpecInitProviderAutomaticUpdatePolicy? AutomaticUpdatePolicy { get; set; }
    ...
    /// <summary>Security patches are only applied when a function is redeployed. This should be specified as an empty block and cannot be set alongside automatic_update_policy. Structure is documented below.</summary>
    [JsonPropertyName("onDeployUpdatePolicy")]
    public V1beta1FunctionSpecInitProviderOnDeployUpdatePolicy? OnDeployUpdatePolicy { get; set; }
...
public partial class V1beta1FunctionStatusAtProvider
{
    /// <summary>Security patches are applied automatically to the runtime without requiring the function to be redeployed. This should be specified as an empty block and cannot be set alongside on_deploy_update_policy.</summary>
    [JsonPropertyName("automaticUpdatePolicy")]
    public V1beta1FunctionStatusAtProviderAutomaticUpdatePolicy? AutomaticUpdatePolicy { get; set; }
    ...
    /// <summary>Security patches are only applied when a function is redeployed. This should be specified as an empty block and cannot be set alongside automatic_update_policy. Structure is documented below.</summary>
    [JsonPropertyName("onDeployUpdatePolicy")]
    public V1beta1FunctionStatusAtProviderOnDeployUpdatePolicy? OnDeployUpdatePolicy { get; set; }
