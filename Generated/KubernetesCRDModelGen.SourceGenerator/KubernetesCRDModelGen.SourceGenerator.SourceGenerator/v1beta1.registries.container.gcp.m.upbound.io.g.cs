...
/// <summary>Registry is the Schema for the Registrys API. Ensures the GCS bucket backing Google Container Registry exists.</summary>
...
{
    /// <summary>The location of the registry. One of ASIA, EU, US or not specified. See the official documentation for more information on registry locations.</summary>
...
public partial class V1beta1RegistryStatusAtProvider
{
    ...
    [JsonPropertyName("bucketSelfLink")]
    public string? BucketSelfLink { get; set; }

    /// <summary>The name of the bucket that supports the Container Registry. In the form of artifacts.{project}.appspot.com or {location}.artifacts.{project}.appspot.com if location is specified.</summary>
    [JsonPropertyName("id")]
