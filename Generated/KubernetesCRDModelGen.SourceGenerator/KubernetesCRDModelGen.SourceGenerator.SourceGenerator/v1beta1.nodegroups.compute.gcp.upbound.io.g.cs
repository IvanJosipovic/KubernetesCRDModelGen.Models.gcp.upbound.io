...
public partial class V1beta1NodeGroupSpecForProvider
{
    ...
    public IList<V1beta1NodeGroupSpecForProviderAutoscalingPolicy>? AutoscalingPolicy { get; set; }
    ...
    public IList<V1beta1NodeGroupSpecForProviderMaintenanceWindow>? MaintenanceWindow { get; set; }
    ...
    public IList<V1beta1NodeGroupSpecForProviderShareSettings>? ShareSettings { get; set; }
...
public partial class V1beta1NodeGroupSpecInitProvider
{
    ...
    /// </summary>
    [JsonPropertyName("autoscalingPolicy")]
    public IList<V1beta1NodeGroupSpecInitProviderAutoscalingPolicy>? AutoscalingPolicy { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("maintenanceWindow")]
    public IList<V1beta1NodeGroupSpecInitProviderMaintenanceWindow>? MaintenanceWindow { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("shareSettings")]
    public IList<V1beta1NodeGroupSpecInitProviderShareSettings>? ShareSettings { get; set; }
}
...
public partial class V1beta1NodeGroupStatusAtProvider
{
    ...
    /// </summary>
    [JsonPropertyName("autoscalingPolicy")]
    public IList<V1beta1NodeGroupStatusAtProviderAutoscalingPolicy>? AutoscalingPolicy { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("maintenanceWindow")]
    public IList<V1beta1NodeGroupStatusAtProviderMaintenanceWindow>? MaintenanceWindow { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("shareSettings")]
    public IList<V1beta1NodeGroupStatusAtProviderShareSettings>? ShareSettings { get; set; }
