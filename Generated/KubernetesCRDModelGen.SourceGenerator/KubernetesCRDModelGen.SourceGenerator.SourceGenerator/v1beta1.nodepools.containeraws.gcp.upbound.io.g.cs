...
public partial class V1beta1NodePoolList : IKubernetesObject<V1ListMeta>, IItems<V1beta1NodePool>
{
    ...
    public string ApiVersion { get; set; } = "containeraws.gcp.upbound.io/v1beta1";
...
public partial class V1beta1NodePoolSpecForProviderConfig
{
    ...
    public IList<V1beta1NodePoolSpecForProviderConfigAutoscalingMetricsCollection>? AutoscalingMetricsCollection { get; set; }

    /// <summary>The ARN of the AWS KMS key used to encrypt node pool configuration.</summary>
    [JsonPropertyName("configEncryption")]
    public IList<V1beta1NodePoolSpecForProviderConfigConfigEncryption>? ConfigEncryption { get; set; }
...
public partial class V1beta1NodePoolSpecForProvider
{
    ...
    public IList<V1beta1NodePoolSpecForProviderUpdateSettings>? UpdateSettings { get; set; }
...
public partial class V1beta1NodePoolSpecInitProviderConfig
{
    /// <summary>Optional. Configuration related to CloudWatch metrics collection on the Auto Scaling group of the node pool. When unspecified, metrics collection is disabled.</summary>
    [JsonPropertyName("autoscalingMetricsCollection")]
    public IList<V1beta1NodePoolSpecInitProviderConfigAutoscalingMetricsCollection>? AutoscalingMetricsCollection { get; set; }

    /// <summary>The ARN of the AWS KMS key used to encrypt node pool configuration.</summary>
    [JsonPropertyName("configEncryption")]
    public IList<V1beta1NodePoolSpecInitProviderConfigConfigEncryption>? ConfigEncryption { get; set; }
...
public partial class V1beta1NodePoolSpecInitProvider
{
    ...
    /// <summary>Optional. Update settings control the speed and disruption of the node pool update.</summary>
    [JsonPropertyName("updateSettings")]
    public IList<V1beta1NodePoolSpecInitProviderUpdateSettings>? UpdateSettings { get; set; }
...
public partial class V1beta1NodePoolStatusAtProviderConfig
{
    /// <summary>Optional. Configuration related to CloudWatch metrics collection on the Auto Scaling group of the node pool. When unspecified, metrics collection is disabled.</summary>
    [JsonPropertyName("autoscalingMetricsCollection")]
    public IList<V1beta1NodePoolStatusAtProviderConfigAutoscalingMetricsCollection>? AutoscalingMetricsCollection { get; set; }

    /// <summary>The ARN of the AWS KMS key used to encrypt node pool configuration.</summary>
    [JsonPropertyName("configEncryption")]
    public IList<V1beta1NodePoolStatusAtProviderConfigConfigEncryption>? ConfigEncryption { get; set; }
...
public partial class V1beta1NodePoolStatusAtProvider
{
    ...
    /// <summary>Optional. Update settings control the speed and disruption of the node pool update.</summary>
    [JsonPropertyName("updateSettings")]
    public IList<V1beta1NodePoolStatusAtProviderUpdateSettings>? UpdateSettings { get; set; }
