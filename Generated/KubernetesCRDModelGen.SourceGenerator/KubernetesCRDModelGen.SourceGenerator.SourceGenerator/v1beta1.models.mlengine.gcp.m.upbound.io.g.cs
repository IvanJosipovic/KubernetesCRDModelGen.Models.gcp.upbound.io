...
namespace KubernetesCRDModelGen.Models.mlengine.gcp.m.upbound.io;
...
public partial class V1beta1ModelList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Model>
{
    ...
    public const string KubeGroup = "mlengine.gcp.m.upbound.io";
    public const string KubePluralName = "models";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    public string ApiVersion { get; set; } = "mlengine.gcp.m.upbound.io/v1beta1";
    ...
    public required IList<V1beta1Model> Items { get; set; }
}
...
public partial class V1beta1ModelSpecForProvider
{
    ...
    public V1beta1ModelSpecForProviderDefaultVersion? DefaultVersion { get; set; }
...
public partial class V1beta1ModelSpecInitProvider
{
    ...
    /// </summary>
    [JsonPropertyName("defaultVersion")]
    public V1beta1ModelSpecInitProviderDefaultVersion? DefaultVersion { get; set; }
...
public partial class V1beta1ModelStatusAtProvider
{
    ...
    /// </summary>
    [JsonPropertyName("defaultVersion")]
    public V1beta1ModelStatusAtProviderDefaultVersion? DefaultVersion { get; set; }
