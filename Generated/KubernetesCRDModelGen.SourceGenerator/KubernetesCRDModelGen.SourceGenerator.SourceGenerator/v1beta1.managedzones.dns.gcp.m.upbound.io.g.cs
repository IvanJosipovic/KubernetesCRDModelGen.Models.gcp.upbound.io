...
public partial class V1beta1ManagedZoneList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ManagedZone>
{
    ...
    /// <summary>List of V1beta1ManagedZone objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ManagedZone> Items { get; set; }
}
...
public partial class V1beta1ManagedZoneSpecForProvider
{
    ...
    public V1beta1ManagedZoneSpecForProviderCloudLoggingConfig? CloudLoggingConfig { get; set; }
    ...
    public V1beta1ManagedZoneSpecForProviderDnssecConfig? DnssecConfig { get; set; }
    ...
    public V1beta1ManagedZoneSpecForProviderForwardingConfig? ForwardingConfig { get; set; }
    ...
    public V1beta1ManagedZoneSpecForProviderPeeringConfig? PeeringConfig { get; set; }
    ...
    public V1beta1ManagedZoneSpecForProviderPrivateVisibilityConfig? PrivateVisibilityConfig { get; set; }
...
public partial class V1beta1ManagedZoneSpecInitProvider
{
    ...
    /// </summary>
    [JsonPropertyName("cloudLoggingConfig")]
    public V1beta1ManagedZoneSpecInitProviderCloudLoggingConfig? CloudLoggingConfig { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("dnssecConfig")]
    public V1beta1ManagedZoneSpecInitProviderDnssecConfig? DnssecConfig { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("forwardingConfig")]
    public V1beta1ManagedZoneSpecInitProviderForwardingConfig? ForwardingConfig { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("peeringConfig")]
    public V1beta1ManagedZoneSpecInitProviderPeeringConfig? PeeringConfig { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("privateVisibilityConfig")]
    public V1beta1ManagedZoneSpecInitProviderPrivateVisibilityConfig? PrivateVisibilityConfig { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1ManagedZoneSpecManagementPoliciesEnum>))]
...
public partial class V1beta1ManagedZoneSpec
{
    ...
    public required V1beta1ManagedZoneSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1ManagedZoneStatusAtProvider
{
    ...
    /// </summary>
    [JsonPropertyName("cloudLoggingConfig")]
    public V1beta1ManagedZoneStatusAtProviderCloudLoggingConfig? CloudLoggingConfig { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("dnssecConfig")]
    public V1beta1ManagedZoneStatusAtProviderDnssecConfig? DnssecConfig { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("forwardingConfig")]
    public V1beta1ManagedZoneStatusAtProviderForwardingConfig? ForwardingConfig { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("peeringConfig")]
    public V1beta1ManagedZoneStatusAtProviderPeeringConfig? PeeringConfig { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("privateVisibilityConfig")]
    public V1beta1ManagedZoneStatusAtProviderPrivateVisibilityConfig? PrivateVisibilityConfig { get; set; }
...
public partial class V1beta1ManagedZone : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ManagedZoneSpec>, IStatus<V1beta1ManagedZoneStatus?>
{
    ...
    public required V1beta1ManagedZoneSpec Spec { get; set; }
