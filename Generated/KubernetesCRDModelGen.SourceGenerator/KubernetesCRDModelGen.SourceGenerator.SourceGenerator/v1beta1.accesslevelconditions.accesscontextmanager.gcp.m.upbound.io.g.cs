...
public partial class V1beta1AccessLevelConditionList : IKubernetesObject<V1ListMeta>, IItems<V1beta1AccessLevelCondition>
{
    ...
    /// <summary>List of V1beta1AccessLevelCondition objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1AccessLevelCondition> Items { get; set; }
}
...
public partial class V1beta1AccessLevelConditionSpecForProvider
{
    ...
    public V1beta1AccessLevelConditionSpecForProviderDevicePolicy? DevicePolicy { get; set; }
...
public partial class V1beta1AccessLevelConditionSpecInitProvider
{
    ...
    /// </summary>
    [JsonPropertyName("devicePolicy")]
    public V1beta1AccessLevelConditionSpecInitProviderDevicePolicy? DevicePolicy { get; set; }
...
public partial class V1beta1AccessLevelConditionSpec
{
    ...
    public required V1beta1AccessLevelConditionSpecForProvider ForProvider { get; set; }
...
public partial class V1beta1AccessLevelConditionStatusAtProvider
{
    ...
    /// </summary>
    [JsonPropertyName("devicePolicy")]
    public V1beta1AccessLevelConditionStatusAtProviderDevicePolicy? DevicePolicy { get; set; }
...
public partial class V1beta1AccessLevelCondition : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1AccessLevelConditionSpec>, IStatus<V1beta1AccessLevelConditionStatus?>
{
    ...
    public required V1beta1AccessLevelConditionSpec Spec { get; set; }
