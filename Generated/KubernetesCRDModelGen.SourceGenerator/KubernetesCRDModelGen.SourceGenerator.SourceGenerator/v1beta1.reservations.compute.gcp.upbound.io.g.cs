...
public partial class V1beta1ReservationSpecForProvider
{
    ...
    public IList<V1beta1ReservationSpecForProviderDeleteAfterDuration>? DeleteAfterDuration { get; set; }
    ...
    public IList<V1beta1ReservationSpecForProviderReservationSharingPolicy>? ReservationSharingPolicy { get; set; }
...
public partial class V1beta1ReservationSpecInitProvider
{
    ...
    /// </summary>
    [JsonPropertyName("deleteAfterDuration")]
    public IList<V1beta1ReservationSpecInitProviderDeleteAfterDuration>? DeleteAfterDuration { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("reservationSharingPolicy")]
    public IList<V1beta1ReservationSpecInitProviderReservationSharingPolicy>? ReservationSharingPolicy { get; set; }
...
public partial class V1beta1ReservationStatusAtProvider
{
    ...
    /// </summary>
    [JsonPropertyName("deleteAfterDuration")]
    public IList<V1beta1ReservationStatusAtProviderDeleteAfterDuration>? DeleteAfterDuration { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("reservationSharingPolicy")]
    public IList<V1beta1ReservationStatusAtProviderReservationSharingPolicy>? ReservationSharingPolicy { get; set; }
