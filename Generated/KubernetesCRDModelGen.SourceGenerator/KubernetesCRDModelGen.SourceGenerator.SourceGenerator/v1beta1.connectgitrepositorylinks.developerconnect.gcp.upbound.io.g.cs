...
public partial class V1beta1ConnectGitRepositoryLinkList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ConnectGitRepositoryLink>
{
    ...
    public const string KubeKind = "ConnectGitRepositoryLinkList";
    public const string KubeGroup = "developerconnect.gcp.upbound.io";
    public const string KubePluralName = "connectgitrepositorylinks";
    ...
    public string Kind { get; set; } = "ConnectGitRepositoryLinkList";
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1ConnectGitRepositoryLinkSpecDeletionPolicyEnum>))]
public enum V1beta1ConnectGitRepositoryLinkSpecDeletionPolicyEnum
{
...
public partial class V1beta1ConnectGitRepositoryLinkSpecForProviderParentConnectionRefPolicy
{
    ...
    public V1beta1ConnectGitRepositoryLinkSpecForProviderParentConnectionRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ConnectGitRepositoryLinkSpecForProviderParentConnectionRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ConnectGitRepositoryLinkSpecForProviderParentConnectionRef
{
    ...
    public V1beta1ConnectGitRepositoryLinkSpecForProviderParentConnectionRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ConnectGitRepositoryLinkSpecForProviderParentConnectionSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ConnectGitRepositoryLinkSpecForProviderParentConnectionSelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ConnectGitRepositoryLinkSpecForProviderParentConnectionSelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ConnectGitRepositoryLinkSpecForProvider
{
    ...
    /// <summary>Resource ID segment making up resource name. It identifies the resource within its parent collection as described in https://google.aip.dev/122. See documentation for resource type developerconnect.googleapis.com/GitRepositoryLink.</summary>
    [JsonPropertyName("location")]
    public required string Location { get; set; }

    /// <summary>Resource ID segment making up resource name. It identifies the resource within its parent collection as described in https://google.aip.dev/122. See documentation for resource type developerconnect.googleapis.com/GitRepositoryLink.</summary>
    [JsonPropertyName("parentConnection")]
    public string? ParentConnection { get; set; }

    /// <summary>Reference to a ConnectConnection in developerconnect to populate parentConnection.</summary>
    [JsonPropertyName("parentConnectionRef")]
    public V1beta1ConnectGitRepositoryLinkSpecForProviderParentConnectionRef? ParentConnectionRef { get; set; }

    /// <summary>Selector for a ConnectConnection in developerconnect to populate parentConnection.</summary>
    [JsonPropertyName("parentConnectionSelector")]
    public V1beta1ConnectGitRepositoryLinkSpecForProviderParentConnectionSelector? ParentConnectionSelector { get; set; }
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1ConnectGitRepositoryLinkSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1ConnectGitRepositoryLinkSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1ConnectGitRepositoryLinkSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1ConnectGitRepositoryLinkSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1ConnectGitRepositoryLinkSpecProviderConfigRefPolicy
{
    /// <summary>
    /// Resolution specifies whether resolution of this reference is required.
    /// The default is &apos;Required&apos;, which means the reconcile will fail if the
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ConnectGitRepositoryLinkSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ConnectGitRepositoryLinkSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ConnectGitRepositoryLinkSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ConnectGitRepositoryLinkSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ConnectGitRepositoryLinkSpec
{
    ...
    public V1beta1ConnectGitRepositoryLinkSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1ConnectGitRepositoryLinkSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1ConnectGitRepositoryLinkSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1ConnectGitRepositoryLinkSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1ConnectGitRepositoryLinkSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1ConnectGitRepositoryLinkStatusAtProvider
{
    ...
    /// <summary>an identifier for the resource with format projects/{{project}}/locations/{{location}}/connections/{{parent_connection}}/gitRepositoryLinks/{{git_repository_link_id}}</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1ConnectGitRepositoryLinkStatus
{
    ...
    public V1beta1ConnectGitRepositoryLinkStatusAtProvider? AtProvider { get; set; }

    /// <summary>Conditions of the resource.</summary>
    [JsonPropertyName("conditions")]
    public IList<V1beta1ConnectGitRepositoryLinkStatusConditions>? Conditions { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "ConnectGitRepositoryLink";
    public const string KubeGroup = "developerconnect.gcp.upbound.io";
    public const string KubePluralName = "connectgitrepositorylinks";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ConnectGitRepositoryLink";
    ...
    public required V1beta1ConnectGitRepositoryLinkSpec Spec { get; set; }

    /// <summary>ConnectGitRepositoryLinkStatus defines the observed state of ConnectGitRepositoryLink.</summary>
    [JsonPropertyName("status")]
    public V1beta1ConnectGitRepositoryLinkStatus? Status { get; set; }
}