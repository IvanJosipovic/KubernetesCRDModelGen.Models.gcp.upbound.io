...
public partial class V1beta1MetastoreServiceList : IKubernetesObject<V1ListMeta>, IItems<V1beta1MetastoreService>
{
    ...
    public string ApiVersion { get; set; } = "dataproc.gcp.upbound.io/v1beta1";
...
public partial class V1beta1MetastoreServiceSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1MetastoreServiceSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1MetastoreServiceSpec
{
    ...
    public V1beta1MetastoreServiceSpecDeletionPolicyEnum? DeletionPolicy { get; set; }
