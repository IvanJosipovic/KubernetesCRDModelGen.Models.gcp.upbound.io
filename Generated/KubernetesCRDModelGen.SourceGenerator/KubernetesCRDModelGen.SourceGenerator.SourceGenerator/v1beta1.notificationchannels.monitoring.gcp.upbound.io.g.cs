...
public partial class V1beta1NotificationChannelList : IKubernetesObject<V1ListMeta>, IItems<V1beta1NotificationChannel>
{
    ...
    /// <summary>List of V1beta1NotificationChannel objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1NotificationChannel> Items { get; set; }
}
...
public partial class V1beta1NotificationChannelSpecForProvider
{
    ...
    public IList<V1beta1NotificationChannelSpecForProviderSensitiveLabels>? SensitiveLabels { get; set; }
...
public partial class V1beta1NotificationChannelSpecInitProvider
{
    ...
    /// </summary>
    [JsonPropertyName("sensitiveLabels")]
    public IList<V1beta1NotificationChannelSpecInitProviderSensitiveLabels>? SensitiveLabels { get; set; }
...
public partial class V1beta1NotificationChannelSpecProviderConfigRefPolicy
{
    ...
    public V1beta1NotificationChannelSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1NotificationChannelSpec
{
    ...
    public V1beta1NotificationChannelSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1NotificationChannelSpecForProvider ForProvider { get; set; }
    ...
    public IList<V1beta1NotificationChannelSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
...
public partial class V1beta1NotificationChannelStatusAtProvider
{
    ...
    /// </summary>
    [JsonPropertyName("sensitiveLabels")]
    public IList<V1beta1NotificationChannelStatusAtProviderSensitiveLabels>? SensitiveLabels { get; set; }
...
public partial class V1beta1NotificationChannel : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1NotificationChannelSpec>, IStatus<V1beta1NotificationChannelStatus?>
{
    ...
    public required V1beta1NotificationChannelSpec Spec { get; set; }
