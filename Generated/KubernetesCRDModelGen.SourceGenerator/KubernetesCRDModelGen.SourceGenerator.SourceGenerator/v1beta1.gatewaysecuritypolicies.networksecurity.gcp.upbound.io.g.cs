...
public partial class V1beta1GatewaySecurityPolicyList : IKubernetesObject<V1ListMeta>, IItems<V1beta1GatewaySecurityPolicy>
{
    ...
    public const string KubeKind = "GatewaySecurityPolicyList";
    public const string KubeGroup = "networksecurity.gcp.upbound.io";
    public const string KubePluralName = "gatewaysecuritypolicies";
    ...
    public string Kind { get; set; } = "GatewaySecurityPolicyList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1GatewaySecurityPolicy objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1GatewaySecurityPolicy> Items { get; set; }
}
...
public partial class V1beta1GatewaySecurityPolicySpecForProviderTlsInspectionPolicyRefPolicy
{
    ...
    public V1beta1GatewaySecurityPolicySpecForProviderTlsInspectionPolicyRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1GatewaySecurityPolicySpecForProviderTlsInspectionPolicyRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GatewaySecurityPolicySpecForProviderTlsInspectionPolicySelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GatewaySecurityPolicySpecForProviderTlsInspectionPolicySelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GatewaySecurityPolicySpecForProviderTlsInspectionPolicySelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GatewaySecurityPolicySpecInitProviderTlsInspectionPolicyRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GatewaySecurityPolicySpecInitProviderTlsInspectionPolicyRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GatewaySecurityPolicySpecInitProviderTlsInspectionPolicyRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GatewaySecurityPolicySpecInitProviderTlsInspectionPolicySelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GatewaySecurityPolicySpecInitProviderTlsInspectionPolicySelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GatewaySecurityPolicySpecInitProviderTlsInspectionPolicySelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GatewaySecurityPolicySpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1GatewaySecurityPolicySpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1GatewaySecurityPolicySpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1GatewaySecurityPolicySpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1GatewaySecurityPolicySpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1GatewaySecurityPolicySpec
{
    ...
    public V1beta1GatewaySecurityPolicySpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1GatewaySecurityPolicySpecForProvider ForProvider { get; set; }
    ...
    public V1beta1GatewaySecurityPolicySpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1GatewaySecurityPolicySpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1GatewaySecurityPolicySpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1GatewaySecurityPolicyStatusAtProvider
{
    ...
    /// <summary>an identifier for the resource with format projects/{{project}}/locations/{{location}}/gatewaySecurityPolicies/{{name}}</summary>
    [JsonPropertyName("id")]
...
public partial class V1beta1GatewaySecurityPolicyStatus
{
    ...
    public V1beta1GatewaySecurityPolicyStatusAtProvider? AtProvider { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "GatewaySecurityPolicy";
    public const string KubeGroup = "networksecurity.gcp.upbound.io";
    public const string KubePluralName = "gatewaysecuritypolicies";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "GatewaySecurityPolicy";
    ...
    public required V1beta1GatewaySecurityPolicySpec Spec { get; set; }

    /// <summary>GatewaySecurityPolicyStatus defines the observed state of GatewaySecurityPolicy.</summary>
    [JsonPropertyName("status")]
    public V1beta1GatewaySecurityPolicyStatus? Status { get; set; }
}