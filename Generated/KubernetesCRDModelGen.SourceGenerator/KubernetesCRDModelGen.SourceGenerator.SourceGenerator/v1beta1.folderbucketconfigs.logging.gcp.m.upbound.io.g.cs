...
public partial class V1beta1FolderBucketConfigSpecForProvider
{
    ...
    public V1beta1FolderBucketConfigSpecForProviderCmekSettings? CmekSettings { get; set; }
...
{
    [JsonPropertyName("cmekSettings")]
    public V1beta1FolderBucketConfigSpecInitProviderCmekSettings? CmekSettings { get; set; }
...
public partial class V1beta1FolderBucketConfigStatusAtProvider
{
    ...
    [JsonPropertyName("cmekSettings")]
    public V1beta1FolderBucketConfigStatusAtProviderCmekSettings? CmekSettings { get; set; }
