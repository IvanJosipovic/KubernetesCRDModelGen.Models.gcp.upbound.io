...
public partial class V1beta1EndpointAttachmentList : IKubernetesObject<V1ListMeta>, IItems<V1beta1EndpointAttachment>
{
    ...
    public const string KubeKind = "EndpointAttachmentList";
    public const string KubeGroup = "apigee.gcp.upbound.io";
    public const string KubePluralName = "endpointattachments";
    ...
    public string Kind { get; set; } = "EndpointAttachmentList";
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1EndpointAttachmentSpecDeletionPolicyEnum>))]
public enum V1beta1EndpointAttachmentSpecDeletionPolicyEnum
{
...
public partial class V1beta1EndpointAttachmentSpecForProviderServiceAttachmentRefPolicy
{
    ...
    public V1beta1EndpointAttachmentSpecForProviderServiceAttachmentRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1EndpointAttachmentSpecForProviderServiceAttachmentRef
{
    ...
    public V1beta1EndpointAttachmentSpecForProviderServiceAttachmentRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1EndpointAttachmentSpecForProviderServiceAttachmentSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1EndpointAttachmentSpecForProviderServiceAttachmentSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1EndpointAttachmentSpecForProvider
{
    ...
    public V1beta1EndpointAttachmentSpecForProviderServiceAttachmentRef? ServiceAttachmentRef { get; set; }

    /// <summary>Selector for a ServiceAttachment in compute to populate serviceAttachment.</summary>
    [JsonPropertyName("serviceAttachmentSelector")]
    public V1beta1EndpointAttachmentSpecForProviderServiceAttachmentSelector? ServiceAttachmentSelector { get; set; }
}
...
public partial class V1beta1EndpointAttachmentSpecInitProviderServiceAttachmentRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1EndpointAttachmentSpecInitProviderServiceAttachmentRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1EndpointAttachmentSpecInitProviderServiceAttachmentRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1EndpointAttachmentSpecInitProviderServiceAttachmentRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1EndpointAttachmentSpecInitProviderServiceAttachmentSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1EndpointAttachmentSpecInitProviderServiceAttachmentSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1EndpointAttachmentSpecInitProvider
{
    ...
    /// <summary>Reference to a ServiceAttachment in compute to populate serviceAttachment.</summary>
    [JsonPropertyName("serviceAttachmentRef")]
    public V1beta1EndpointAttachmentSpecInitProviderServiceAttachmentRef? ServiceAttachmentRef { get; set; }

    /// <summary>Selector for a ServiceAttachment in compute to populate serviceAttachment.</summary>
    [JsonPropertyName("serviceAttachmentSelector")]
    public V1beta1EndpointAttachmentSpecInitProviderServiceAttachmentSelector? ServiceAttachmentSelector { get; set; }
}
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1EndpointAttachmentSpecProviderConfigRefPolicyResolutionEnum>))]
public enum V1beta1EndpointAttachmentSpecProviderConfigRefPolicyResolutionEnum
{
    [EnumMember(Value = "Required"), JsonStringEnumMemberName("Required")]
    Required,
    [EnumMember(Value = "Optional"), JsonStringEnumMemberName("Optional")]
...
/// </summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.2+8c7b4a3647c1e77cd3e3152af5701ec2357dafe9")]
[JsonConverter(typeof(JsonStringEnumConverter<V1beta1EndpointAttachmentSpecProviderConfigRefPolicyResolveEnum>))]
public enum V1beta1EndpointAttachmentSpecProviderConfigRefPolicyResolveEnum
{
    [EnumMember(Value = "Always"), JsonStringEnumMemberName("Always")]
    Always,
    [EnumMember(Value = "IfNotPresent"), JsonStringEnumMemberName("IfNotPresent")]
...
public partial class V1beta1EndpointAttachmentSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1EndpointAttachmentSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1EndpointAttachmentSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1EndpointAttachmentSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1EndpointAttachmentSpec
{
    ...
    public V1beta1EndpointAttachmentSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1EndpointAttachmentSpecForProvider ForProvider { get; set; }
    ...
    public V1beta1EndpointAttachmentSpecInitProvider? InitProvider { get; set; }
    ...
    public IList<V1beta1EndpointAttachmentSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
    ...
    public V1beta1EndpointAttachmentSpecProviderConfigRef? ProviderConfigRef { get; set; }
...
public partial class V1beta1EndpointAttachmentStatus
{
    ...
    public V1beta1EndpointAttachmentStatusAtProvider? AtProvider { get; set; }
...
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "EndpointAttachment";
    public const string KubeGroup = "apigee.gcp.upbound.io";
    public const string KubePluralName = "endpointattachments";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "EndpointAttachment";
    ...
    public required V1beta1EndpointAttachmentSpec Spec { get; set; }
