...
public partial class V1beta1DomainMappingSpecForProvider
{
    ...
    /// </summary>
    [JsonPropertyName("metadata")]
    public V1beta1DomainMappingSpecForProviderMetadata? Metadata { get; set; }
    ...
    public V1beta1DomainMappingSpecForProviderSpec? Spec { get; set; }
}
...
public partial class V1beta1DomainMappingSpecInitProvider
{
    ...
    /// </summary>
    [JsonPropertyName("metadata")]
    public V1beta1DomainMappingSpecInitProviderMetadata? Metadata { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("spec")]
    public V1beta1DomainMappingSpecInitProviderSpec? Spec { get; set; }
}
...
public partial class V1beta1DomainMappingStatusAtProvider
{
    ...
    /// </summary>
    [JsonPropertyName("metadata")]
    public V1beta1DomainMappingStatusAtProviderMetadata? Metadata { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("spec")]
    public V1beta1DomainMappingStatusAtProviderSpec? Spec { get; set; }
