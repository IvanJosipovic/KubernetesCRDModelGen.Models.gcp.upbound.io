...
namespace KubernetesCRDModelGen.Models.activedirectory.gcp.m.upbound.io;
/// <summary>Domain is the Schema for the Domains API. Creates a Microsoft AD domain</summary>
...
public partial class V1beta1DomainList : IKubernetesObject<V1ListMeta>, IItems<V1beta1Domain>
{
    ...
    public const string KubeGroup = "activedirectory.gcp.m.upbound.io";
    public const string KubePluralName = "domains";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    public string ApiVersion { get; set; } = "activedirectory.gcp.m.upbound.io/v1beta1";
...
public partial class V1beta1DomainStatusAtProvider
{
    ...
    /// <summary>The unique name of the domain using the format: projects/{project}/locations/global/domains/{domainName}.</summary>
    [JsonPropertyName("name")]
