...
public partial class V1beta1ResponsePolicyRuleList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ResponsePolicyRule>
{
    ...
    public string Kind { get; set; } = "ResponsePolicyRuleList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ResponsePolicyRule objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ResponsePolicyRule> Items { get; set; }
}
...
public partial class V1beta1ResponsePolicyRuleSpecForProviderResponsePolicyRefPolicy
{
    ...
    public V1beta1ResponsePolicyRuleSpecForProviderResponsePolicyRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    public V1beta1ResponsePolicyRuleSpecForProviderResponsePolicyRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ResponsePolicyRuleSpecForProviderResponsePolicySelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ResponsePolicyRuleSpecForProviderResponsePolicySelectorPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ResponsePolicyRuleSpecForProviderResponsePolicySelectorPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ResponsePolicyRuleSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ResponsePolicyRuleSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("resolve")]
    public V1beta1ResponsePolicyRuleSpecProviderConfigRefPolicyResolveEnum? Resolve { get; set; }
}
...
public partial class V1beta1ResponsePolicyRuleSpec
{
    ...
    public V1beta1ResponsePolicyRuleSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1ResponsePolicyRuleSpecForProvider ForProvider { get; set; }
    ...
    public IList<V1beta1ResponsePolicyRuleSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
...
public partial class V1beta1ResponsePolicyRule : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ResponsePolicyRuleSpec>, IStatus<V1beta1ResponsePolicyRuleStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ResponsePolicyRule";
    ...
    public required V1beta1ResponsePolicyRuleSpec Spec { get; set; }
