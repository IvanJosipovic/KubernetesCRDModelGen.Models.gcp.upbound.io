...
public partial class V1beta1ApplicationURLDispatchRulesList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ApplicationURLDispatchRules>
{
    ...
    public string Kind { get; set; } = "ApplicationURLDispatchRulesList";
...
public partial class V1beta1ApplicationURLDispatchRulesSpecForProviderDispatchRulesServiceRefPolicy
{
    ...
    public V1beta1ApplicationURLDispatchRulesSpecForProviderDispatchRulesServiceRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ApplicationURLDispatchRulesSpecForProviderDispatchRulesServiceSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ApplicationURLDispatchRulesSpecForProviderDispatchRulesServiceSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ApplicationURLDispatchRulesSpecInitProviderDispatchRulesServiceRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ApplicationURLDispatchRulesSpecInitProviderDispatchRulesServiceRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ApplicationURLDispatchRulesSpecInitProviderDispatchRulesServiceSelectorPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ApplicationURLDispatchRulesSpecInitProviderDispatchRulesServiceSelectorPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ApplicationURLDispatchRulesSpecProviderConfigRefPolicy
{
    ...
    /// </summary>
    [JsonPropertyName("resolution")]
    public V1beta1ApplicationURLDispatchRulesSpecProviderConfigRefPolicyResolutionEnum? Resolution { get; set; }
...
public partial class V1beta1ApplicationURLDispatchRulesSpecProviderConfigRef
{
    ...
    /// <summary>Policies for referencing.</summary>
    [JsonPropertyName("policy")]
    public V1beta1ApplicationURLDispatchRulesSpecProviderConfigRefPolicy? Policy { get; set; }
}
...
public partial class V1beta1ApplicationURLDispatchRulesSpec
{
    ...
    public V1beta1ApplicationURLDispatchRulesSpecDeletionPolicyEnum? DeletionPolicy { get; set; }

    [JsonPropertyName("forProvider")]
    public required V1beta1ApplicationURLDispatchRulesSpecForProvider ForProvider { get; set; }
    ...
    public IList<V1beta1ApplicationURLDispatchRulesSpecManagementPoliciesEnum>? ManagementPolicies { get; set; }
...
public partial class V1beta1ApplicationURLDispatchRules : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ApplicationURLDispatchRulesSpec>, IStatus<V1beta1ApplicationURLDispatchRulesStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ApplicationURLDispatchRules";
    ...
    public required V1beta1ApplicationURLDispatchRulesSpec Spec { get; set; }
